...
- Russia is responsible for a striking number of cannibals, and worse: it lets them go free[![Search for topic in EUvsDisinfo](../all_common_img/Wikipedia.png){height=1em}](https://en.wikipedia.org/wiki/List_of_incidents_of_cannibalism)
:::
