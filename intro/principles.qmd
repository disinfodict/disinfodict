...
- we never use machine translation without checking and correcting and we use the high-quality translator from [deepl](deepl.com)
- we only translate into languages we speak well, and if we are not native speakers, we use [deepl](deepl.com) back-translations to check the meaning
